    ...
    <div class="position-relative">
      ...
      <div class="js-swiper-blog-journal-hero swiper">
        <div class="swiper-wrapper">
          <div class="js-swiper-slide-preload swiper-slide d-flex gradient-x-overlay-sm-dark bg-img-start" style="background-image: url(assets/img/1920x1080/img3.jpg); min-height: 40rem;">
            <!-- Container -->
              ...
              <div class="w-lg-50 me-3">
                ...
                <div class="d-flex align-items-center mb-3">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <a class="text-white" href="blog-article.html">Alexandre Novaes Iosimura</a>
                  </div>
                </div>
                <!-- End Media -->

                <div class="mb-5">
                  <h2 class="h1 text-white">Da entrevista ao MVP com seu cliente: uma jornada possível com low code.</h2>
                </div>
                
                <a class="btn btn-primary btn-transition" href="blog-article.html">Ler o artigo<i class="bi-chevron-right small ms-1"></i></a>
              </div>
            </div>
            <!-- End Container -->
          </div>

          <div class="js-swiper-slide-preload swiper-slide d-flex gradient-x-overlay-sm-dark bg-img-start" style="background-image: url(assets/img/1920x1080/img5.jpg); min-height: 40rem;">
            <!-- Container -->
            <div class="container d-flex align-items-center" style="min-height: 40rem;">
              <div class="w-lg-50 me-3">
                <!-- Media -->
                <div class="d-flex align-items-center mb-3">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <a class="text-white" href="blog-article.html">Osama Nadeen</a>
                  </div>
                </div>
                <!-- End Media -->

                <div class="mb-5">
                  <h2 class="h1 text-white">Low Code + Code : Acelerando processos de construção com a finalização do IU/UX manualmente.</h2>
                </div>
          ...
          <div class="js-swiper-slide-preload swiper-slide d-flex gradient-x-overlay-sm-dark bg-img-start" style="background-image: url(assets/img/1920x1080/img4.jpg); min-height: 40rem;">
            <!-- Container -->
            <div class="container d-flex align-items-center" style="min-height: 40rem;">
              <div class="w-lg-50 me-3">
                <!-- Media -->
                <div class="d-flex align-items-center mb-3">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <a class="text-white" href="blog-article.html">Fabiano Leite</a>
                  </div>
                </div>
                <!-- End Media -->

                <div class="mb-5">
                  <h2 class="h1 text-white">EDI em projetos governamentais e a assinatura eletrônica para prontuários médicos.</h2>
                </div>
                
                <a class="btn btn-primary btn-transition" href="blog-article.html">Ler artigo<i class="bi-chevron-right small ms-1"></i></a>
              </div>
            </div>
            <!-- End Container -->
          </div>
